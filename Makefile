...
LD_FLAGS = -X github.com/stafiprotocol/rsol-relay/cmd.Version=$(VERSION) \
	-X github.com/stafiprotocol/rsol-relay/cmd.Commit=$(COMMIT) \
...
build:
	...
	go build -mod readonly $(BUILD_FLAGS) -o build/rsol-relay main.go

build-linux:
	@GOOS=linux GOARCH=amd64 go build --mod readonly $(BUILD_FLAGS) -o ./build/rsol-relay main.go
